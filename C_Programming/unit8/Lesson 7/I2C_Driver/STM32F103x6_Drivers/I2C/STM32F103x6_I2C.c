...
I2C_Config_t  G_I2C_PinConfig[2] = {0,0};
...
void MCAL_I2C_GPIO_Set_Pins(I2C_TypeDef *I2Cx)
{
	if(I2Cx == I2C1)
	{
		// PB6:I2C1_SCL
		// PB7:I2C1_SDA
		MCAL_GPIO_SET_Pin(GPIOB, GPIO_PIN_6, GPIO_MODE_Output_AF_OD, GPIO_MAX_Speed_10M);
		MCAL_GPIO_SET_Pin(GPIOB, GPIO_PIN_7, GPIO_MODE_Output_AF_OD, GPIO_MAX_Speed_10M);
	}
	else if(I2Cx == I2C2)
	{
		// PB10:I2C2_SCL
		// PB11:I2C2_SDA
		MCAL_GPIO_SET_Pin(GPIOB, GPIO_PIN_10, GPIO_MODE_Output_AF_OD, GPIO_MAX_Speed_10M);
		MCAL_GPIO_SET_Pin(GPIOB, GPIO_PIN_11, GPIO_MODE_Output_AF_OD, GPIO_MAX_Speed_10M);
	}
}
/* ================================================================
