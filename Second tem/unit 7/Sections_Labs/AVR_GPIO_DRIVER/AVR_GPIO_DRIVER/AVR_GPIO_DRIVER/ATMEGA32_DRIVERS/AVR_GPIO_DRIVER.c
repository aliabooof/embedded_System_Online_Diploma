 ...
 * AVR_GPIO_DRIVER.c
 *
 * Created: 9/10/2023 5:45:12 AM
 *  Author: aliab
 */ 

#include "../ATMEGA32_DRIVERS/inc/AVR_GPIO_DRIVER.h"
 ...
 *Note                  - None
 */
vuint8_t MCAL_GPIO_ReadPin(GPIO_Typedef_t * GPIOx, vuint8_t PinNumber)
{
    vuint8_t PinState = 0;
    ...
    switch(PinNumber)
    {
        case GPIO_PIN_0:
        {
            PinState = (vuint8_t)(GPIOx->PIN.bits.PIN0);
            break;
        }
        case GPIO_PIN_1:
        {
            PinState = (vuint8_t)(GPIOx->PIN.bits.PIN1);
            break;
        }
        case GPIO_PIN_2:
        {
            PinState = (vuint8_t)(GPIOx->PIN.bits.PIN2);
            break;
        }
        case GPIO_PIN_3:
        {
            PinState = (vuint8_t)(GPIOx->PIN.bits.PIN3);
            break;
        }
        case GPIO_PIN_4:
        {
            PinState = (vuint8_t)(GPIOx->PIN.bits.PIN4);
            break;
        }
        case GPIO_PIN_5:
        {
            PinState = (vuint8_t)(GPIOx->PIN.bits.PIN5);
            break;
        }
        case GPIO_PIN_6:
        {
            PinState = (vuint8_t)(GPIOx->PIN.bits.PIN6);
            break;
        }
        case GPIO_PIN_7:
        {
            PinState = (vuint8_t)(GPIOx->PIN.bits.PIN7);
            break;
        }
    }
    return PinState;
 ...
 *Note                  - None
 */
vuint8_t MCAL_GPIO_ReadPort(GPIO_Typedef_t * GPIOx)
{
    vuint8_t PortState = 0x00;
    PortState = (vuint8_t)(GPIOx->PIN.PIN);
    return PortState;
}
 ...
 *Note                  - None
 */
void MCAL_GPIO_WritePin(GPIO_Typedef_t * GPIOx, vuint8_t PinNumber, vuint8_t data)
{
    switch(PinNumber)
    {
        case GPIO_PIN_0:
...
void MCAL_GPIO_WritePort(GPIO_Typedef_t * GPIOx, vuint8_t data)
{
 ...
 *Note                  - None
 */
void MCAL_GPIO_TogglePin(GPIO_Typedef_t * GPIOx, vuint8_t PinNumber)
{
    switch(PinNumber)
    {
        case GPIO_PIN_0:
